...
window.onload = function () {
	...
	html+=	"<div id='buttons'><ul><li><a href='Yelp_Input.php'>Search</a></li><br><li><a href='Vulcan_Login.php'>Login</a></li><br><li><a href='Vulcan_Signup.php'>Signup</a></li></ul></div>";
	html += "</div>";
